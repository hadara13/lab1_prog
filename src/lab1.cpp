...
int main()
{
     ...
     */
     ...
     {
        /*
 * If no constructor is defineded,the compiler creates an implicit default constructor.
 * When a parameterized constructor is added, the default one is no longer generated.
 * Therefore, we must explicitly define a default constructor to allow object creation without parameters.*/
     ...
     */
     ...
     {
         //Rect rect1(1, 2, 3, 4); // it calls the parameterized constructor  ... (1)  
        //Rect rect2 = rect1;    // it calls the copy constructor            ... (2)
       //Rect rect3(rect1);    // it calls the copy constructor             ... (3) // there are 0 differences between (2) and (3) in the memory 
      // case1 : it initializes an object type Rect with special values 
     // case2 : it initializes an object type Rect , which is a copy of rect1 with the same values that means (rect2.right = rect1.right и т.д)
    // case3 : it is another way to make a copy of any initialized object  
     ...
     */
    /* AAnswers : the destructor is called to every object we init and by reversed it works , which means it starts destroying from the last object to the first one 
    ...
    /* {
        Rect r1; // default
        Rect *pR = new Rect(1,2,1,2);  copy constructor 
        {
            Rect r2(r1); copy 
            Rect arRect[2]; default 2 times for each item it calls once 
            for(int i = 0; i < 3; i++)
            {
                static Rect r3 (i,i,i,i) ; param 1time because it is static
                Rect r4(*pR); copy 3times
                Rect r5(i,i,i,i); param 3times 
            }
        }
        delete pR;  
    } */
        /*RRESULTS : 
        DEFAULT :  3 times  , PARAM : 5 times , COPY : 4 times 
        */
    /**
     ...
     */
     ...
     {
        //Rect r1;
        // std::cout << r1.top << std::endl; ERROR declared private here 
    }
     ...
     */
     ...
     /*{
       Rect r;
       std::cout << r.get_left() << "; " << r.get_right() << '\n'; // it gives the default values from the constructor
       r.set_all(1, 2, 3, 4); // here the auto vlues change to the assigned ones 
    ...
    Member function:
    - belongs to a class
    - is usually called through an object
    ...
    - does not have direct access to private members
 ...
 */
    ...
    /* {
        Rect r1(...), r2(...); param constructor 2times
        Rect r3 = bounding_rect(r1, r2); copy constructor 2 times (for r1 , r2) and then we have returned a param construcrot 
        we also assigned the vlaues so it calls the copy constructor for r3
        
        print_rect(r3); here call by refrence , so we do no constructors 
    } */
    ...
    { /*
        Rect r1(10, 50 , 20 , 60 ) ; // left ,right , top , bottom 
        cout<< "###### Before changing ####### " << endl ;
        cout <<"Left : " << r1.get_left() << endl;
        cout <<"Right : " << r1.get_right() << endl;
        cout <<"Top : " << r1.get_top() << endl;
        cout <<"Bottom : " << r1.get_bottom() << endl;
        cout <<"Width : " << r1.get_width() << endl;
        cout <<"Height : " << r1.get_height() << endl;
        cout <<"Square : " << r1.get_square() << endl;

        cout<< "###### After changing the width : ####### " << endl ;
        r1.set_width(200);
        cout <<"Left : " << r1.get_left() << endl;
        cout <<"Right : " << r1.get_right() << endl;
        cout <<"Top : " << r1.get_top() << endl;
        cout <<"Bottom : " << r1.get_bottom() << endl;
        cout <<"Width : " << r1.get_width() << endl;
        cout <<"Height : " << r1.get_height() << endl; // no change 
        cout <<"Square : " << r1.get_square() << endl;

         r1.set_height(80);
        cout<< "###### After changing the height : ####### " << endl ;
        cout <<"Left : " << r1.get_left() << endl;
        cout <<"Right : " << r1.get_right() << endl;
        cout <<"Top : " << r1.get_top() << endl;
        cout <<"Bottom : " << r1.get_bottom() << endl;
        cout <<"Width : " << r1.get_width() << endl; // no change 
        cout <<"Height : " << r1.get_height() << endl; 
        cout <<"Square : " << r1.get_square() << endl;
    */}
    ...
    /* {
        ...
        // it works since i defined the copy cons
    } */
